...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/azadrahorg/Install-MikroTik-CHR-on-VPS/main/mik78.sh](https://raw.githubusercontent.com/TrDuckTail/Install-MikroTik-CHR-on-VPS/main/mik78.sh)"
```
